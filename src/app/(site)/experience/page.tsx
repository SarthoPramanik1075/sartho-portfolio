...
export default async function ExperiencePage() {
  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-12 px-6 py-20">
      <h1 className="font-heading text-4xl font-semibold tracking-tight">Experience</h1>
        ...
        <div className="flex flex-col">
          {experience.map((role) => {
            ...
            return (
              <div
                key={role._id}
                className="flex gap-4 border-t border-border/60 py-8 first:border-t-0 first:pt-0"
              >
                {logoUrl ? (
                  <Image
                    src={logoUrl}
